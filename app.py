...
if choice == 'HOME':
    ...
    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'><strong><span style="font-size: 20px; line-height: 107%; color: rgb(143, 170, 220);">GRAPHICAL APPROACH TO PATIENT BEHAVIOR</span></strong></p>
