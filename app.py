...
if choice == 'HOME':
    ...
    stc.html('''<p style='margin-top:0cm;margin-right:0cm;margin-bottom:2.0pt;margin-left:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'><strong><span style="font-size: 20px; line-height: 107%; color: rgb(143, 170, 220);">GRAPHICAL APPROACH TO PATIENT BEHAVIOR</span></strong></p>
            <p style='margin-top:0cm;margin-right:0cm;margin-bottom:0.0pt;margin-left:0cm;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'>We invite you to navigate in the side menu to view the graphical statistics of the patients in our EDA. &nbsp;</p>''')
